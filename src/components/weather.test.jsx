...
// // // const mockStore = configureStore([]); // Initialize the mock store
...
// // //     // Check if fetchWeather is dispatched with the city name
...
// // //     store = mockStore({
// // //       weather: { weatherData: mockWeatherData, status: 'succeeded', error: null },
// // //     });
...
// // //     // Check if weather data is rendered correctly
...
// //   it('renders weather data when available', () => {
// //     // Mock the implementation of fetchWeather to return mock data
...
// //     store = mockStore({
// //       weather: { weatherData: { temperature: 25, location: 'Lagos', humidity: 80, windSpeed: 10, icon: '10d' }, status: 'succeeded', error: null },
// //     });
...
// import Weather from './Weather';
// import { fetchWeather } from './weatherSlice';
// import { WeatherProvider } from './WeatherContext'; // Import the context provider
...
// // Wrap with Provider and WeatherContext
// const renderWithProviderAndContext = (store) =>
//   render(
//     <Provider store={store}>
//       <WeatherProvider> {/* Use WeatherProvider here */}
//         <Weather />
//       </WeatherProvider>
//     </Provider>
//   );
